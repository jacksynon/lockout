      ...
      {state.success ? (
        <>
          <div className="flex items-center justify-center">
            ...
            <p className="ml-4 text-center text-sm text-neutral-500">
              A link has been sent to your email to sign in
            </p>
          </div>
        </>
      ) : (
              ...
              <div className="grid w-full gap-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormDescription>
                        A link will be sent to your email to sign in
                      </FormDescription>
                      <FormControl>
                        <Input
